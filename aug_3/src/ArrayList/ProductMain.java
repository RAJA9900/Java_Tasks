...
public class ProductMain {
		...
		public static void main(String[] args) {
			...
			productList.add(new Product(1, "Bread", 35.55, 4.5, 3));
			productList.add(new Product(2, "Milk", 28.00, 4.9, 5));
			productList.add(new Product(3, "Juice", 95.90, 4.6, 6));
			productList.add(new Product(4, "Chicken", 280.99, 4.4, 1));
			productList.add(new Product(5, "Nuts", 599.99, 3.9, 2));
			productList.add(new Product(6, "Tea", 399.99, 4.1, 9));
			productList.add(new Product(7, "Dhall", 239.99, 4.7, 1));
